...
/// Vibrant color palette for party/events app
class LightModeColors {
  // Primary: Energetic purple for party vibe
  ...
  // Surface and background: Clean and bright
...
/// Dark mode colors with vibrant accents
class DarkModeColors {
  ...
  // Tertiary
  static const darkTertiary = Color(0xFF60A5FA);
  static const darkOnTertiary = Color(0xFF1E3A8A);
  ...
  // Surface and background: Rich dark mode
